...
var inputs = _interopRequireWildcard(_index);
    ...
    _createClass(Field, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                type = _props.type,
                name = _props.name,
                other = _objectWithoutProperties(_props, ['type', 'name']);
            ...
            return _react2.default.createElement(Input, _extends({ ref: function ref(input) {
                    return _this2.inp = input;
                }, name: name }, other, { onFocus: this.handleFocus.bind(this) }));
        }
    }]);
